...
import AffiliateGrid from "@/components/Grids/AffiliateGrid";
  ...
  const fetchData = async (extraQuery: ExtraQuery) => {
    if (session) {
      try {
        ...
        const result = await apiService.fetchAffiliates({...extraQuery });
        ...
        console.error('Erro ao obter dados dos afiliados:', error);
      }
    }
  };
                  ...
                  <div className="container-xxl flex-grow-1 container-p-y">
                    <Loading>
                      ...
                      <Pagination
                        ...
                        lastId={lastId}
                        fetchData={fetchData}
                        quantityModels={affiliates.length}
                      />
                    </Loading>
                  </div>
                  <Footer />
